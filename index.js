...
const b64 = (content = '', decode = false) =>
  Buffer.from(content, contentType[decode]).toString(contentType[!decode])
...
http
  .createServer((req, res) => {
    ...
    req.on('end', () => {
      ...
      const ret = b64(content, req.url === '/decode') // b64(content:string, decode:bool):string
      res.writeHead(200, {
